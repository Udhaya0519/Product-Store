...
describe("runModeInitialize", () => {
    ...
    it("logs help text when from help is true", async () => {
        ...
        expect(mockLogInitializeHelpText).toHaveBeenCalledWith("create-typescript-app", { help: true, yes: undefined });
        expect(actual).toBe(mockHelpTextReturn);
    });
    it("logs help text with yes when from help is true and yes is true", async () => {
        ...
        expect(mockLogInitializeHelpText).toHaveBeenCalledWith("create-typescript-app", { help: true, yes: true });
        expect(actual).toBe(mockHelpTextReturn);
    });
